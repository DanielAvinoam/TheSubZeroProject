...
const std::wstring REG_VALUE_NAME = L"GoogleUpdateClient";
...
const std::wstring DRIVER_FULL_PATH = DIRECTORY_PATH + DRIVER_FILE_NAME;
const std::wstring DLL_FULL_PATH = DIRECTORY_PATH + DLL_FILE_NAME;
const std::wstring LOADER_FULL_PATH = DIRECTORY_PATH + REG_VALUE_NAME + L".exe";